...
public class SocksOverHTTPSHandler implements HttpHandler {
	private IOManager io;

	public SocksOverHTTPSHandler(IOManager io) {
		this.io = io;
	}
	...
	public void handle(HttpExchange t) throws IOException {
		...
		//TODO Consolidate with PortForwarder
		...
		String forwardRequest = t.getRequestHeaders().getFirst("ProxyId");

		...
		try {
			...
			while (stayAlive) {
				try {
					...
					//When the socket is closed, often there is corruption in the fileContentLength transmissions. 
					//test for corruption. 
					...
					Path localFilePath = Paths.get(rootPath.toString(),
							remoteRootPath.relativize(filenamePath).toString());
